...
$query1= "select * from flight where origin in (SELECT location from admin where admin_id='{$adminID}')";
  ...
  <div class="shell">
    ...
    <div id="navigation">
      <ul>
        ...
        <li><a href="#"><span><b >New Articles</b></span></a></li>
        <li><a href="#"><span><b>User Management</b></span></a></li>
        <li><a href="#"><span><b>Photo Gallery</b></span></a></li>
        <li><a href="#"><span><b>Products</b></span></a></li>
        <li><a href="#"><span><b>Services Control</b></span></a></li>
      </ul>
    </div>
